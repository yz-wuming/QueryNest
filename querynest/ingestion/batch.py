"""
Batch processing functionality for QueryNest
...
class BatchMixin:
    """BatchMixin class containing batch processing functionality for QueryNest"""

    # Type hints for mixin attributes (will be available when mixed into QueryNest)

...
4. Optionally merge the extracted equations into an already-parsed
   ...
   by :class:`querynest.ingestion.parser.MineruParser` / :class:`DoclingParser`)
...
Example
-------
>>> from querynest.multimodal.omml_extractor import extract_omml_equations
...
def enrich_content_list_with_docx_equations(
    ...
    *,
    ...
    content_list:
        ...
        :class:`querynest.ingestion.parser.MineruParser` or
        :class:`querynest.ingestion.parser.DoclingParser`. The list is *not* mutated;

...
def read_long_description():
    try:
        ...
        return "A description of QueryNest is currently unavailable."
...
def retrieve_metadata():
    ...
    vars2readme = {}
    try:
        with open("./querynest/__init__.py") as f:
        ...
        raise FileNotFoundError("Metadata file './querynest/__init__.py' not found.")
...
setuptools.setup(
    ...
    entry_points={
        "console_scripts": ["querynest=querynest.cli:main"],
    },
    classifiers=[
